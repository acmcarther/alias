...
in pkgs.stdenv.mkDerivation rec {
  name = "space_coop";
  buildInputs = [ pkgs.mesa_glu pkgs.freetype pkgs.mesa pkgs.cmake pkgs.xlibs.libX11 pkgs.xlibs.libXxf86vm pkgs.xlibs.libXi pkgs.xlibs.libXrandr pkgs.xlibs.libXinerama pkgs.xlibs.libXcursor pkgs.xlibs.libXext pkgs.xlibs.libXfixes pkgs.ruby pkgs.openssl];
